...
import NfceConverter from "./nfce-converter";

export const metadata: Metadata = {
  title: "Conversor NFC-e para Excel e PDF | Linha agio",
  description:
    "Converta XMLs de NFC-e em Excel analitico por produto, analitico por nota e relatorios resumidos em PDF.",
};

export default function ConversorNfcePage() {
  return (
    <>
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-8 max-w-4xl text-4xl font-semibold leading-tight text-white md:text-6xl">
              Conversor NFC-e para Excel e PDF.
            </h1>
            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
              Importe XMLs de NFC-e, pastas ou arquivos ZIP para transformar a
              rotina de conferencia em saidas prontas: analitico por produto,
              analitico por nota e resumo em PDF.
            </p>
          </div>
          ...
          <div className="surface-card rounded-[28px] border border-white/10 p-6 md:p-7">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              O tipo NFC-e ja vem selecionado. A ferramenta aceita XML unico,
              multiplos XMLs, pasta pelo navegador e ZIP com XMLs em ate cinco
              niveis de subpastas. RAR fica mapeado como proxima camada tecnica.
            </p>
          </div>
        </section>
